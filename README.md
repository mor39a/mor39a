...
public class Mora {
  ...
  public string[] workingOn = {
    ...
    "[Active] Personal Backup Manager (C# - WPF)",
...
<div align="center">
  ...
  |-------------|------|----------|---------|------------|
  | 30s Spanish | 82.4 | 99.53%   | 84.8    | 9 Aug 2026 |
  <!--Monkeytype-End-->
